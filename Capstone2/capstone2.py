...
for user in user_credentials:#reading the user credentials stored in the file line by line
    temp_user=[]
    temp_user=user.split(", ")#categorising the data in a line by using comma(,)
...
while authorised==False:
    ...
    if username in users.keys(): #checking username with keys of the dictonary
        if password in users.values(): #checking password with values in the dictonary
            authorised=True
...
while  authorised==True:
    ...
    #In this block you will write code to add a new user to the user.txt file
        if username=="adminA":
            username=input("\tEnter username:\t") #Request input of a new username
            while True:
                password=input("\tEnter password:\t")  #Request input of a new password   
                confirm_password=input("\tconfirm password:\t")# Request input of password confirmation
                if password==confirm_password: #Check if the new password and confirmed password are the same.
                    break
                else:
            ...
            print(user_credentials.readlines())   
        else:
    ...
    #In this block you will put code that will allow a user to add a new task to task.txt file
        ...
        if username=="adminA":
            ...
            print("You are not authorized to check the staistics.")                
    elif menu == 'e':
        print('Goodbye!!!')
        exit()
